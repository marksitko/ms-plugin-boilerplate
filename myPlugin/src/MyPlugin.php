...
namespace mp;
use mp\Loader;
use mp\controllers\PublicController;
use mp\controllers\AdminController;
use mp\controllers\AjaxController;
...
class MyPlugin {
	...
	*/
	public static function instance() {
		...
		if( !self::$instance  && !self::$instance instanceof MyPlugin) {
	...
	*/
	private function define_hooks() {
		...
		// init shortcodes
		$this->loader->add_shortcode( 'wpMyPluginEntry', $this->publicController, 'entry' );
		$this->loader->add_shortcode( 'wpMyPluginAdminEntry', $this->adminController, 'adminEntry' );
	}
